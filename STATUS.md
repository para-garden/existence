...
## Interactions (226 + dynamic item interactions)
...
State: `pharmacy_last_fill` (game-minutes), `medication_supply` (Record<string, number> — days remaining per med; depletes 1/day in advanceTime), `illness_medicated` (bool — 0.4× illness NT effects when true; clears when illness supply runs out).
