...
- **Craving calc (advanceTime):** composite from all active withdrawals (nicotine×0.6, alcohol×0.8, cannabis×0.5, opioid×0.9). Location amplification: corner_store (nicotine×1.3, alcohol×1.2), street (nicotine×1.15). Approximation debt (recovery): coefficients chosen.
