...
## Interactions (189 + dynamic item interactions)
...
Connected to: apartment_kitchen (2 min), bus_stop (3 min), corner_store (4 min), park (7 min), soup_kitchen (8 min), library (10 min), shelter (10 min), food_bank (12 min), friends_apartment (15 min), clinic (15 min), gym (20 min, gym_membership gate).
...
### Global (26, available outside phone mode based on own availability check)
