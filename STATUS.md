...
- **Craving calc (advanceTime):** composite from all active withdrawals (nicotine×0.6, alcohol×0.8, cannabis×0.5), scaled by `taperingFactor()` per substance. Location amplification: corner_store (nicotine×1.3, alcohol×1.2), street (nicotine×1.15). Approximation debt (recovery): coefficients chosen.
...
## Interactions (242 + dynamic item interactions)
